...
echonet_category_dict = {'left ventricle': 0}
echonet_category_list = ['left ventricle']
# -------------------------------------------------------------------------------------------------------------------
# 4. CAMUS (LV Endo, LV Myo, LA segmentation)
camus_category_dict = {
    'left ventricle endocardium': 0,
    'left ventricle myocardium': 1,
    'left atrium': 2
}
camus_category_list = list(camus_category_dict.keys())